...
|       Design                     |                   |      |
|       |                          v                   |      |
|       v                    Phase 6: Self-Review      |      |
|  Phase 3: Execution &           & Revision ----------+      |
|       Monitoring                 |                          |
|       |                          v                          |
|       v                    Phase 7: Submission               |
...
This skill is designed for the Nexus agent. It uses Nexus tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Nexus skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.nexus/plans/` | `skill_view("plan")` |
